    ...
    <AuthSplit
      panel={
        <>
          ...
          <p style={{ color: "rgba(255,255,255,.70)", lineHeight: 1.9, fontSize: 14.5, marginBlock: "14px 26px" }}>{t("panelLoginBody")}</p>
          <div style={{ padding: 20, borderRadius: 16, background: "rgba(255,255,255,.05)", border: "1px solid rgba(255,255,255,.1)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBlockEnd: 12 }}>
              ...
              <span style={{ fontSize: 12.5, color: "rgba(255,255,255,.70)", fontWeight: 600 }}>{t("panelLoginCardEyebrow")}</span>
            </div>
            <div style={{ fontSize: 18, fontWeight: 700, lineHeight: 1.6 }}>{t("panelLoginCardTitle")}</div>
            <div style={{ fontSize: 13, color: "rgba(255,255,255,.52)", marginBlockStart: 6 }}>{t("panelLoginCardBody")}</div>
          </div>
        </>
      }
    >
