    ...
    <AuthSplit
      panel={
        <>
          ...
          <p style={{ color: "rgba(255,255,255,.70)", lineHeight: 1.9, fontSize: 14.5, marginBlock: "14px 26px" }}>{t("panelForgotBody")}</p>
          <div style={{ padding: 20, borderRadius: 16, background: "rgba(232, 138, 161,.1)", border: "1px solid rgba(232, 138, 161,.25)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBlockEnd: 12 }}>
              <span style={{ display: "grid", placeItems: "center", width: 32, height: 32, borderRadius: 9, background: "rgba(232, 138, 161,.2)", color: "var(--teal-light)" }}>
            ...
            <div style={{ fontSize: 13, color: "rgba(255,255,255,.52)", marginBlockStart: 6 }}>{t("panelForgotCardBody")}</div>
          </div>
        </>
      }
    >
