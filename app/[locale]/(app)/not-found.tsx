...
export default async function NotFound() {
  ...
  return (
    <main style={{ maxWidth: 520, margin: "0 auto", padding: "clamp(48px,10vw,110px) 24px", textAlign: "center" }}>
      ...
      <Link href="/dashboard" style={{ height: 46, padding: "0 22px", borderRadius: 12, display: "inline-grid", placeItems: "center", background: "linear-gradient(135deg,var(--navy-2),var(--navy))", color: "#fff", fontWeight: 700, fontSize: 14.5, textDecoration: "none" }}>{cta}</Link>
    </main>
  );
}
